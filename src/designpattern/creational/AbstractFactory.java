...
public class AbstractFactory {
	...
	public static void Test_AbstractFactory() {
    	...
    	// Implement a PointCornerFactory and implement these interfaces of Point and Corner.
    	AbstractFactory.PointCornerFactory factory =
            new AbstractFactory.PointCornerFactory() {
